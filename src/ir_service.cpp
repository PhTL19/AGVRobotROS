...
bool irled_to_state(avg_robot::IRSignal::Request  &req, avg_robot::IRSignal::Response &res) {
    ROS_INFO("IR_read: IR_1=%d, IR_2=%d, IR_3=%d, IR_4=%d, IR_5=%d", req.IR_1, req.IR_2, req.IR_3, req.IR_4, req.IR_5);
    ...
    ROS_INFO("State: [%s]", res.state.c_str());
    return true;
}
...
int main(int argc, char **argv)
{
    ...
    ros::ServiceServer service = n.advertiseService("ir_signal", irled_to_state);
    ROS_INFO("IR Signal: ");
    ros::spin();
